...
/**
 * ============================================================================
 * AUTO_ROUTES.PHP - RUTAS PARA GESTIÓN AUTOMÁTICA DE HORARIOS
 * ============================================================================
 * 
 * Este archivo contiene todas las rutas relacionadas con:
 * 1. Consulta de horarios de aulas
 * 2. Verificación de disponibilidad de aulas
 * 3. Generación automática de horarios (DESHABILITADA)
 * 4. Asignación manual de clases
 * 5. Visualización de horarios generados
 * 
 * Dependencias:
 * - Laravel Request, Route, Session
 * - App\Config (conexión a PostgreSQL)
 * 
 * Base de datos: ex_g32 (PostgreSQL)
 * 
...
// ============================================================================
// SECCIÓN 1: CONSULTA DE HORARIOS DE AULAS
// ============================================================================

/**
 * GET /auto/aulas/horario
 * 
 * Obtiene el horario completo de un aula específica en una gestión
 * 
 * Parámetros GET:
 * - aula_nro: Número del aula (requerido)
 * - gestion_id: ID de la gestión académica (requerido)
 * 
 * Retorna:
 * - success: boolean
 * - aula: {nro, capacidad, modulo, tipo}
 * - gestion: {id, nombre}
 * - horarios: Array de clases asignadas con información completa
 * 
 * Relaciones BD:
 * CLASE -> HORARIO (id_horario)
 * CLASE -> MATERIA_GRUPO (id_materia_grupo)
 * CLASE -> GESTION (id_gestion)
 * MATERIA_GRUPO -> MATERIA (sigla_materia)
 */
...
// ============================================================================
// SECCIÓN 2: DISPONIBILIDAD DE AULAS
// ============================================================================

/**
 * GET /auto/aulas/disponibilidad
 * 
 * Obtiene las aulas disponibles para un horario específico
 * 
 * Parámetros GET:
 * - gestion_id: ID de la gestión académica (requerido)
 * - dia: Día de la semana (Lun, Mar, Mie, Jue, Vie, Sab) (requerido)
 * - hora_inicio: Hora de inicio en formato HH:MM (requerido)
 * - hora_fin: Hora de fin en formato HH:MM (requerido)
 * 
 * Retorna:
 * - success: boolean
 * - aulas_disponibles: Array de aulas libres
 * - aulas_ocupadas: Array de aulas ocupadas con detalles
 * 
 * Lógica:
 * 1. Valida parámetros de entrada
 * 2. Obtiene todas las aulas del sistema
 * 3. Verifica conflictos de horario para cada aula
 * 4. Clasifica aulas en disponibles/ocupadas
 */
...
// ================================================================================
// Método: POST
// Ruta: /auto/generar-horario/asignar-clase
// 
// DESCRIPCIÓN:
// Permite asignar manualmente clases a una materia-grupo en una gestión específica.
// El usuario selecciona de 1 a 4 horarios diferentes (en días distintos) y el sistema:
// 1. Valida las horas semanales según la carga horaria de la materia
// 2. Busca aulas disponibles para cada horario
// 3. Crea las clases en la base de datos
//
// PARÁMETROS DE ENTRADA (JSON):
// - docente_codigo: Código del docente asignado
// - horario_ids: Array con IDs de horarios (1-4 elementos, algunos pueden ser null)
// - sigla_materia: Sigla de la materia (ej: "INF342")
// - sigla_grupo: Sigla del grupo (ej: "SA")
// - gestion_id: ID de la gestión académica
//
// VALIDACIONES:
// 1. Usuario autenticado
// 2. Datos completos (todos los campos requeridos)
// 3. Al menos 1 horario seleccionado
// 4. Materia existe en BD
// 5. No existen clases previas para materia-grupo en esta gestión
// 6. Horarios en días DIFERENTES (no duplicados)
// 7. Horas semanales según reglas de negocio:
//    - Carga 135 hrs → 4.5 hrs/semana
//    - Carga >135 hrs → 6 hrs/semana
//    - Carga 90 hrs → 3 hrs/semana
//    - Modalidad graduación → 5-7 hrs/semana
// 8. Aulas disponibles para cada horario
//
// RESPUESTAS:
// - 200: Clases asignadas exitosamente
// - 400: Datos incompletos, validación fallida
// - 401: No autenticado
