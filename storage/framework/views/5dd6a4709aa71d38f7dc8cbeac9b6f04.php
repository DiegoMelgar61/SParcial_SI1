...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col font-sans antialiased">
          ...
          <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
              <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nombre del
                  Rol</th>
                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Descripción
                </th>
                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Permisos
                  Asignados</th>
                <th class="px-6 py-3 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider">Acciones
                </th>
              </tr>
            </thead>
                ...
                <tr class="hover:bg-gray-50 transition rol-row">
                  ...
                  <td class="px-6 py-4">
                    <?php if(!empty($rol['permisos'])): ?>
                      <?php $__currentLoopData = $rol['permisos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span
                          class="inline-block bg-blue-50 text-blue-700 text-xs px-2 py-1 rounded-md mr-1 mb-1"><?php echo e($perm['nombre']); ?></span>
                  ...
                  <td class="px-6 py-4 text-center">
                    <div class="flex justify-center gap-3">
                      <!-- Botón Editar Rol -->
                      <button data-id="<?php echo e($rol['id']); ?>" data-nombre="<?php echo e($rol['nombre']); ?>"
            ...
            <tbody id="tabla-permisos" class="bg-white divide-y divide-gray-200 text-sm">
              ...
              <tr id="permisos-loading">
                <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                  <svg class="animate-spin h-5 w-5 mx-auto text-indigo-600" xmlns="http://www.w3.org/2000/svg"
  ...
  <div id="rol-form-modal"
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      <div
        class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-xl">
      ...
      <form id="rol-form" class="p-6 space-y-4">
        ...
        <div>
          ...
          <div id="permisos-checkboxes"
            class="space-y-2 max-h-60 overflow-y-auto border border-gray-200 rounded-lg p-4 bg-gray-50">
    ...
    <div class="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      ...
      <div class="p-6">
        ...
        <div id="roles-checkboxes"
          class="space-y-2 max-h-96 overflow-y-auto border border-gray-200 rounded-lg p-4 bg-gray-50">
...
</html><?php /**PATH D:\whatever that twas, scarcely worth my notice\Brillo\app\templates/roles_permisos.blade.php ENDPATH**/ ?>