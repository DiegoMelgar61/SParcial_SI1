        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    ...
                    <p class="text-xs text-gray-500"><?php echo e(isset($user['rol']) ? ucfirst($user['rol']) : 'Sin rol'); ?></p>
                </div>
...
<?php /**PATH C:\Users\migue\OneDrive\Escritorio\projects\inf342_2exa\app\templates/perfil_nuevo.blade.php ENDPATH**/ ?>