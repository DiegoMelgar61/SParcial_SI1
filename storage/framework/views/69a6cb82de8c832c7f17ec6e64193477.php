            ...
            <tbody id="tabla-roles" class="bg-white divide-y divide-slate-200 text-sm">
              <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-slate-50 transition-all rol-row">
                  ...
                  <td class="px-6 py-4 font-black text-navy-900 nombre-cell border-r border-slate-200"><?php echo e($rol['nombre']); ?></td>
                  <td class="px-6 py-4 text-slate-700 font-semibold descripcion-cell border-r border-slate-200"><?php echo e($rol['descripcion'] ?? '—'); ?></td>
                  <td class="px-6 py-4 border-r border-slate-200">
                    <?php if(!empty($rol['permisos'])): ?>
                      <?php $__currentLoopData = $rol['permisos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="inline-block bg-navy-900 text-gold-500 text-xs px-2 py-1 border border-gold-500 mr-1 mb-1 font-bold"><?php echo e($perm['nombre']); ?></span>
...
<?php /**PATH C:\Users\diego\OneDrive\Escritorio\exa2_inf342\app\templates/roles_permisos.blade.php ENDPATH**/ ?>