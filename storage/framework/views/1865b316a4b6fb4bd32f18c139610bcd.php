...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col font-sans antialiased">
    ...
    <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="usuarios-table-body" class="bg-white divide-y divide-gray-200 text-sm">
                        <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="user-row hover:bg-gray-50" data-perm-id="<?php echo e($rol['id']); ?>">
                                <td class="px-6 py-4 text-gray-700"><?php echo e($index + 1); ?></td>
                                <td class="px-6 py-4 text-gray-800 font-medium"><?php echo e($rol['nombre']); ?></td>
                                <td class="px-6 py-4 text-gray-800 font-medium">
                                    <?php if(!empty($rol['permisos']) && count($rol['permisos']) > 0): ?>
                                         <?php $__currentLoopData = $rol['permisos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge inline-block mr-1 mb-1"><?php echo e($permiso['nombre']); ?></span>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <button data-id="<?php echo e($rol['id']); ?>" data-nombre="<?php echo e($rol['nombre']); ?>"
                                        ...
                                        data-permisos="<?php echo e(implode(',', array_column($rol['permisos'], 'id'))); ?>"
            ...
            <div class="mt-4 text-sm text-gray-500">Mostrando <?php echo e(count($roles)); ?> roles.</div>
    </main>
    ...
    <script src="<?php echo e(asset('static/scripts/admin_roles.js')); ?>"></script>

</body>

</html><?php /**PATH C:\Users\migue\OneDrive\Escritorio\projects\inf342_2exa\app\templates/admin_roles.blade.php ENDPATH**/ ?>