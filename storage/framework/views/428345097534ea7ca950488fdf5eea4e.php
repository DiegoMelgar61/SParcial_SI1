    ...
    <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
        ...
        <div class="bg-white border-2 border-slate-300 shadow-lg overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    <tbody id="grupos-table-body" class="bg-white divide-y divide-slate-200 text-sm">
                        <?php $__empty_1 = true; $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="grupo-row hover:bg-slate-50 transition-all" data-grupo-id="<?php echo e($grupo['sigla']); ?>">
                                <td class="px-6 py-4 text-slate-700 font-semibold border-r border-slate-200"><?php echo e($index + 1); ?></td>
                                <td class="px-6 py-4 text-navy-900 font-bold border-r border-slate-200"><?php echo e($grupo['sigla']); ?></td>
            ...
            <div class="px-6 py-4 bg-slate-50 border-t-2 border-slate-300">
                <p class="text-sm text-slate-600 font-semibold">Mostrando <?php echo e(count($grupos)); ?> grupos.</p>
            </div>
        </div>
    </main>
...
<?php /**PATH C:\Users\diego\OneDrive\Escritorio\exa2_inf342\app\templates/admin_grupos.blade.php ENDPATH**/ ?>