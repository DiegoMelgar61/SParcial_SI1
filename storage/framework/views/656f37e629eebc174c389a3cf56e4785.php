        ...
        <div class="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
            ...
            <div class="flex items-center gap-4">
                <div class="hidden sm:block text-right">
                    ...
                    <p class="text-xs text-gold-500"><?php echo e(isset($user['rol']) ? ucfirst($user['rol']) : 'Sin rol'); ?></p>
                </div>

                <!-- Botón de inicio -->
                <a href="/"
                   class="text-sm bg-gold-500 hover:bg-gold-600 text-navy-900 px-4 py-2 border-b-4 border-gold-600 font-medium transition">
                    Inicio
                </a>
            </div>
        </div>
    ...
    <main class="flex-1 max-w-4xl mx-auto w-full py-10 px-6">
        ...
        <div class="bg-white  shadow-sm border border-gray-200 mb-6">
            ...
            <div class="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 border-b border-gray-200">
                <div class="flex items-center gap-4">
                    <div class="w-16 h-16  bg-navy-900 text-white flex items-center justify-center font-bold text-2xl shadow-lg">
                        <?php echo e(isset($user['nomb_comp']) ? strtoupper(substr($user['nomb_comp'], 0, 1)) : '?'); ?>

                    </div>
                    <div>
                        <h3 class="text-xl font-bold text-gray-900"><?php echo e($user['nomb_comp'] ?? 'Sin nombre'); ?></h3>
                        <p class="text-sm text-gray-600">
                            <span class="inline-flex items-center px-2.5 py-0.5  text-xs font-medium bg-gold-500 text-navy-900">
                                <?php echo e(isset($user['rol']) ? ucfirst($user['rol']) : 'Sin rol'); ?>
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" value="<?php echo e($user['nomb_comp'] ?? ''); ?>" readonly
                               class="w-full border border-gray-300  px-3 py-2 text-sm bg-gray-50 cursor-not-allowed">
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($user['ci'] ?? ''); ?>" readonly
                               class="w-full border border-gray-300  px-3 py-2 text-sm bg-gray-50 cursor-not-allowed">
                        <p class="text-xs text-gray-500 mt-1">Este campo no se puede editar</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($user['codigo'] ?? ''); ?>" readonly
                               class="w-full border border-gray-300  px-3 py-2 text-sm bg-gray-50 cursor-not-allowed">
                        <p class="text-xs text-gray-500 mt-1">Este campo no se puede editar</p>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e(isset($user['rol']) ? ucfirst($user['rol']) : ''); ?>" readonly
                               class="w-full border border-gray-300  px-3 py-2 text-sm bg-gray-50 cursor-not-allowed">
                        <p class="text-xs text-gray-500 mt-1">Este campo no se puede editar</p>
                    </div>

                    <?php if(isset($user['profesion']) && !empty($user['profesion'])): ?>
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Profesión</label>
                        <input type="text" value="<?php echo e($user['profesion']); ?>" readonly
                               class="w-full border border-gray-300  px-3 py-2 text-sm bg-gray-50 cursor-not-allowed">
                        <p class="text-xs text-gray-500 mt-1">Este campo no se puede editar</p>
                    </div>
                    <?php endif; ?>
        ...
        <form id="form-perfil" class="bg-white  shadow-sm border border-gray-200 mb-6">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="tel" id="telefono" name="telefono" value="<?php echo e($user['tel'] ?? ''); ?>"
                               class="w-full border border-gray-300  px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500"
                    ...
                    <div>
                        ...
                        <input type="email" id="correo" name="correo" value="<?php echo e($user['correo'] ?? ''); ?>"
                               class="w-full border border-gray-300  px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500"
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" id="btn-guardar-contacto"
                            class="bg-navy-900 hover:bg-navy-800 text-white px-6 py-2  text-sm font-medium transition shadow-sm">
                        Guardar Cambios
                    </button>
                </div>
            </div>
        ...
        <form id="form-password" class="bg-white  shadow-sm border border-gray-200">
            <div class="p-6 border-b border-gray-200">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" id="password-confirmar" name="password_confirmar"
                               class="w-full border border-gray-300  px-3 py-2 text-sm focus:ring-2 focus:ring-gold-500"
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" id="btn-cambiar-password"
                            class="bg-green-600 hover:bg-green-700 text-white px-6 py-2  text-sm font-medium transition shadow-sm">
                        Cambiar Contraseña
                    </button>
                </div>
            </div>
...
<?php /**PATH C:\Users\diego\OneDrive\Escritorio\exa2_inf342\app\templates/profile.blade.php ENDPATH**/ ?>