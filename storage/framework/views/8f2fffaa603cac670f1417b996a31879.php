...
<body class="bg-gray-50 text-gray-800 min-h-screen flex flex-col font-sans antialiased">
    ...
    <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $permisos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $permiso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="user-row hover:bg-gray-50" data-perm-id="<?php echo e($permiso['id']); ?>">
                            <td class="px-6 py-4 text-gray-700"><?php echo e($index + 1); ?></td>
                            <td class="px-6 py-4 text-gray-800 font-medium"><?php echo e($permiso['nombre']); ?></td>
                            <td class="px-6 py-4 text-gray-600"><?php echo e($permiso['descripcion']); ?></td>
                            <td class="px-6 py-4 text-right">
                                <button data-id="<?php echo e($permiso['id']); ?>" data-nombre="<?php echo e($permiso['nombre']); ?>" data-descripcion="<?php echo e($permiso['descripcion']); ?>"
        ...
        <div class="mt-4 text-sm text-gray-500">Mostrando <?php echo e(count($permisos)); ?> permisos.</div>
    </main>
    ...
    <script src="<?php echo e(asset('static/scripts/admin_permisos.js')); ?>"></script>

</body>
</html>
<?php /**PATH C:\Users\migue\OneDrive\Escritorio\projects\inf342_2exa\app\templates/admin_permisos.blade.php ENDPATH**/ ?>