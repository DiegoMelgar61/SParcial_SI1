    ...
    <aside id="admin-sidebar"
        ...
        <div class="p-6 h-full flex flex-col overflow-y-auto">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="/admin/bitacora"
                            ...
                            <span class="font-medium">Bitácora del Sistema</span>
                        </a>
                    </li>
                    <li>
                        <a href="/admin/grupos" 
            ...
            <div class="mt-6 pt-6 border-t border-gray-200">
                <a href="/" class="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:text-indigo-600">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="materias-table-body" class="bg-white divide-y divide-gray-200 text-sm">
                        <?php $__empty_1 = true; $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="materia-row hover:bg-gray-50" data-materia-id="<?php echo e($materia['sigla']); ?>">
                                <td class="px-6 py-4 text-gray-700"><?php echo e($index + 1); ?></td>
                                <td class="px-6 py-4 text-gray-800 font-medium sigla-cell"><?php echo e($materia['sigla']); ?></td>
                                <td class="px-6 py-4 text-gray-800 nombre-cell"><?php echo e($materia['nombre']); ?></td>
                                <td class="px-6 py-4 text-gray-600 semestre-cell"><?php echo e($materia['semestre']); ?></td>
                                <td class="px-6 py-4 text-gray-600"><?php echo e($materia['carga_horaria']); ?> hrs</td>
                                <td class="px-6 py-4">
                                    <?php if(!empty($materia['grupos']) && count($materia['grupos']) > 0): ?>
                                        <div class="flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $materia['grupos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="inline-block px-2 py-1 text-xs bg-blue-100 text-blue-700 rounded-full"><?php echo e($grupo); ?></span>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="materia-card bg-white rounded-lg shadow-sm border border-gray-200 p-4"
                    ...
                    <div class="flex justify-between items-start mb-3">
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 sigla-cell"><?php echo e($materia['sigla']); ?></h3>
                            <p class="text-sm text-gray-700 nombre-cell"><?php echo e($materia['nombre']); ?></p>
                            <p class="text-sm text-gray-600 semestre-cell mt-1">Semestre: <?php echo e($materia['semestre']); ?></p>
                            <div class="mt-2">
                                <?php if(!empty($materia['grupos']) && count($materia['grupos']) > 0): ?>
                        ...
                        <span
                            class="text-xs bg-indigo-100 text-indigo-700 px-2 py-1 rounded-full"><?php echo e($materia['carga_horaria']); ?>
...
<?php /**PATH C:\Users\migue\OneDrive\Escritorio\projects\inf342_2exa\app\templates/admin_materias.blade.php ENDPATH**/ ?>