...
<body class="bg-slate-50 text-slate-800 min-h-screen flex flex-col font-sans antialiased">
    ...
    <main class="flex-1 md:ml-64 p-6 transition-all duration-300">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    ...
                    @forelse ($aulas as $index => $aula)
                        <tr class="aula-row hover:bg-slate-50" data-aula-nro="{{ $aula['nro'] }}">
                            <td class="px-6 py-4 text-slate-700 font-semibold">{{ $index + 1 }}</td>
                            <td class="px-6 py-4 text-navy-900 font-bold">{{ $aula['nro'] }}</td>
                            <td class="px-6 py-4 text-slate-600 font-medium">{{ $aula['capacidad'] }}</td>
                            <td class="px-6 py-4 text-slate-600 font-medium">{{ $aula['modulo'] }}</td>
        ...
        <div class="mt-4 text-sm text-slate-600 font-semibold">Mostrando {{ count($aulas) }} aulas.</div>
    </main>
