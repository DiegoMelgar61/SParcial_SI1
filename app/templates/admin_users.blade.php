                ...
                <table class="min-w-full divide-y-2 divide-slate-300">
                    ...
                    <tbody id="usuarios-table-body" class="bg-white divide-y divide-slate-200 text-sm">
                        ...
                        @forelse ($usuarios as $usuario)
                            <tr class="user-row hover:bg-slate-50 transition-colors" data-user-id="{{ $usuario['codigo'] }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-slate-700 font-medium border-r border-slate-200">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs text-slate-500">{{ $usuario['tel'] ?? 'Sin teléfono' }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <!-- Botón Eliminar -->
                                        <button data-id="{{ $usuario['codigo'] }}" data-nombre="{{ $usuario['nomb_comp'] }}" class="btn-delete bg-red-700 hover:bg-red-800 text-white p-2 transition-all border-b-2 border-red-800 hover:border-red-600" title="Eliminar Usuario">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
