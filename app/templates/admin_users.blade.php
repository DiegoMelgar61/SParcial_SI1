                    ...
                    <li>
                        <a href="/admin/horarios" 
                           class="flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg transition group">
                            ...
                            <span class="font-medium">Gestión de Horarios</span>
                        </a>
                    </li>
                    <li>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody id="usuarios-table-body" class="bg-white divide-y divide-gray-200 text-sm">
                        ...
                        @forelse ($usuarios as $usuario) <!-- La variable $usuarios viene de tu ruta -->
                            <tr class="user-row hover:bg-gray-50" data-user-id="{{ $usuario['codigo'] }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-gray-600">
                                    <div class="flex flex-col">
                                        ...
                                        <span class="text-xs text-gray-500">{{ $usuario['tel'] ?? 'Sin teléfono' }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <button data-id="{{ $usuario['codigo'] }}" 
                                                data-ci="{{ $usuario['ci'] }}"
                                                data-nombre="{{ $usuario['nomb_comp'] }}"
                                        ...
                                        <!-- Botón Eliminar -->
                                        <button data-id="{{ $usuario['codigo'] }}" data-nombre="{{ $usuario['nomb_comp'] }}" class="btn-delete text-red-600 hover:text-red-900 p-1 rounded-md hover:bg-red-100 transition" title="Eliminar Usuario">
                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
