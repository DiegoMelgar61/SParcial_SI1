            ...
            <div class="p-4">
              ...
              <ul class="text-xs space-y-2">
                ...
                <li class="flex justify-between border-b border-slate-200 pb-1.5">
                  ...
                  <span class="text-navy-900 font-semibold text-right break-all">{{ $user['correo'] ?? '—' }}</span>
                </li>
                <li class="flex justify-between border-b border-slate-200 pb-1.5">
                ...
                <li class="flex justify-between">
                  ...
                  <span class="text-gold-500 font-black uppercase">{{ ucfirst($user['rol']) }}</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="bg-slate-100 px-6 py-4 border-b-4 border-gold-500">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-xs text-slate-600 uppercase">{{ $user['nomb_comp'] }}</p>
                </div>
              </div>
            </div>
            <div class="p-6">
