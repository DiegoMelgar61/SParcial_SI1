...
<body class="bg-slate-100 text-slate-800 min-h-screen flex flex-col">
    ...
    <div id="sidebar-overlay" class="fixed inset-0 bg-navy-900 bg-opacity-70 z-20 hidden md:hidden"></div>
    ...
    <main class="md:ml-64 flex-1 p-6">
        ...
        <!-- Header del módulo corporativo -->
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4 bg-white border-l-4 border-gold-500 shadow-md px-6 py-5">
                <div>
                    <h2 class="text-2xl md:text-3xl font-black text-navy-900 uppercase tracking-tight">Gestión de Materias</h2>
                    <p class="text-sm text-slate-600 font-semibold uppercase tracking-wide mt-1">Administre las materias del sistema académico</p>
                </div>
                <button id="btn-add"
                    class="inline-flex items-center gap-2 bg-navy-900 text-white px-5 py-3 shadow-md hover:bg-navy-800 transition font-bold text-sm uppercase tracking-wide border-b-4 border-navy-800 hover:border-gold-500">
            ...
            <div class="bg-white p-5 shadow-md border-2 border-slate-300">
                <h3 class="text-sm font-black text-navy-900 uppercase tracking-wide mb-4 border-b-2 border-gold-500 pb-2">Filtros de Búsqueda</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                        <label for="filter-sigla" class="block text-xs font-black text-navy-900 mb-2 uppercase tracking-wide">Filtrar por Sigla</label>
                        <input type="text" id="filter-sigla" placeholder="Ej: INF342"
                            class="w-full border-2 border-slate-300 px-3 py-2 text-sm text-navy-900 focus:outline-none focus:border-navy-700 focus:ring-2 focus:ring-navy-700/20 transition-all">
                    </div>
                    <div>
                        <label for="filter-nombre" class="block text-xs font-black text-navy-900 mb-2 uppercase tracking-wide">Filtrar por Nombre</label>
                        <input type="text" id="filter-nombre" placeholder="Ej: Programación"
                            class="w-full border-2 border-slate-300 px-3 py-2 text-sm text-navy-900 focus:outline-none focus:border-navy-700 focus:ring-2 focus:ring-navy-700/20 transition-all">
                    </div>
                    <div>
                        <label for="filter-semestre" class="block text-xs font-black text-navy-900 mb-2 uppercase tracking-wide">Filtrar por Semestre</label>
        ...
        <div class="hidden md:block bg-white border-2 border-slate-300 shadow-lg overflow-hidden">
            <div class="bg-navy-900 px-6 py-4 border-b-4 border-gold-500">
                <h3 class="text-lg font-black text-white uppercase tracking-wide">Registro de Materias</h3>
            </div>
    ...
    <div id="materia-form-modal"
        ...
        <div class="bg-white border-2 border-slate-300 shadow-2xl w-full max-w-md flex flex-col max-h-[90vh]">
            ...
            <div class="flex-shrink-0 bg-navy-900 px-6 py-4 border-b-4 border-gold-500 flex items-center justify-between">
                <h3 id="form-modal-title" class="text-lg font-black text-white uppercase tracking-wide">Agregar Nueva Materia</h3>
            ...
            <form id="materia-form" class="flex-1 flex flex-col min-h-0">
                ...
                <div class="p-6 overflow-y-auto space-y-4">
                    ...
                    <!-- Sigla -->
                    <div>
                        <label for="form-sigla" class="block text-sm font-black text-navy-900 mb-2 uppercase tracking-wide">Sigla *</label>
                        ...
                        <p class="text-xs text-slate-600 mt-2 font-semibold">Ej: INF342, MAT101</p>
                    </div>

                    <!-- Nombre -->
                    <div>
                        <label for="form-nombre" class="block text-sm font-black text-navy-900 mb-2 uppercase tracking-wide">Nombre de la Materia *</label>
                        <input type="text" id="form-nombre" name="nombre"
                            class="w-full border-2 border-slate-300 px-4 py-3 text-sm text-navy-900 focus:outline-none focus:border-navy-700 focus:ring-2 focus:ring-navy-700/20 transition-all"
                            required maxlength="100">
                        <p class="text-xs text-slate-600 mt-2 font-semibold">Ej: Programación Web Avanzada</p>
                    </div>

                    <!-- Semestre -->
                    <div>
                        <label for="form-semestre" class="block text-sm font-black text-navy-900 mb-2 uppercase tracking-wide">Semestre *</label>
                        <input type="number" id="form-semestre" name="semestre" min="1" max="10"
                            class="w-full border-2 border-slate-300 px-4 py-3 text-sm text-navy-900 focus:outline-none focus:border-navy-700 focus:ring-2 focus:ring-navy-700/20 transition-all"
                            required>
                        <p class="text-xs text-slate-600 mt-2 font-semibold">Número del semestre (1-10)</p>
                    </div>

                    <!-- Carga Horaria -->
                    <div>
                        <label for="form-carga-horaria" class="block text-sm font-black text-navy-900 mb-2 uppercase tracking-wide">Carga Horaria *</label>
                        ...
                        <p class="text-xs text-slate-600 mt-2 font-semibold">Carga horaria del semestre</p>
                    </div>

                    <p class="text-xs text-slate-500 font-semibold">* Campos obligatorios</p>
        ...
        <div class="bg-white border-2 border-slate-300 shadow-2xl w-full max-w-md">
            <div class="p-6">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-navy-900 uppercase tracking-wide">Eliminar Materia</h3>
    ...
    <div id="assign-groups-modal"
        ...
        <div class="bg-white border-2 border-slate-300 shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
            ...
            <div class="flex-shrink-0 bg-navy-900 px-6 py-4 border-b-4 border-gold-500 flex items-center justify-between">
                <div>
                    <h3 class="text-lg font-black text-white uppercase tracking-wide">Asignar Grupos</h3>
                    <p class="text-sm text-gold-500 mt-1 font-semibold">Materia: <span id="assign-groups-materia-nombre" class="font-bold"></span></p>
                </div>
                <button id="btn-cancel-assign-x" class="text-slate-300 hover:text-gold-500 transition-all">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <form id="assign-groups-form" class="flex-1 flex flex-col min-h-0">
                ...
                <div class="p-6 overflow-y-auto">
                    <label class="block text-sm font-black text-navy-900 mb-3 uppercase tracking-wide">Seleccione los grupos a asignar</label>
                    ...
                    <div id="grupos-loading" class="text-center py-8 text-slate-500 hidden">
                        <svg class="animate-spin h-8 w-8 mx-auto text-navy-900" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                        <p class="mt-2 font-semibold uppercase tracking-wide">Cargando grupos...</p>
                    </div>
                    <div id="grupos-empty" class="text-center py-8 text-slate-400 hidden">
                        <p class="font-semibold uppercase tracking-wide">No hay grupos disponibles en el sistema.</p>
                    </div>
                </div>

                <!-- Footer del Modal -->
                <div class="flex-shrink-0 bg-slate-50 px-6 py-4 flex justify-between items-center border-t-2 border-slate-300">
