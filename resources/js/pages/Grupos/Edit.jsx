...
export default function Edit({ grupo, gestiones, carreras, turnos }) {
    const { data, setData, put, processing, errors } = useForm({
        gestion_academica_id: grupo.gestion_academica_id || '',
        carrera_id: grupo.carrera_id || '',
        sigla: grupo.sigla || '',
        codigo: grupo.codigo || '',
        nombre: grupo.nombre || '',
        semestre: grupo.semestre || '',
        capacidad: grupo.capacidad || 30,
        turno: grupo.turno || '',
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Actualmente hay {grupo.cantidad_inscritos} estudiante(s) inscrito(s)
                                    </p>
                                </div>
