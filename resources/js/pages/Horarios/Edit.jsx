...
export default function Edit({ horario, grupos, materias, docentes, aulas, diasSemana, bloquesHorarios }) {
    ...
    const [grupoSeleccionado, setGrupoSeleccionado] = useState(
        grupos.find(g => g.id === horario.grupo_id)
    );
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Modifica los datos del horario de clase
                        </p>
                    </div>
