                    ...
                    {horarios.length === 0 ? (
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                            ...
                            <p className="text-gray-500 mb-6">
                                No hay horarios programados para hoy o ya registraste toda tu asistencia.
                            </p>
                            <Link
                                href="/asistencia-docente"
                            ...
                            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                        Selecciona tu clase <span className="text-red-500">*</span>
                                    </label>
                                    <select
                                    ...
                                    >
                                        ...
                                        {horarios.map((horario) => (
                                            <option key={horario.id} value={horario.id}>
                                                {horario.hora_inicio} - {horario.materia?.nombre} (Grupo {horario.grupo?.nombre}) - Aula {horario.aula?.nombre}
                                            </option>
                                        ))}
                                    </select>
                                    {errors.horario_id && (
                                        <p className="mt-1 text-sm text-red-600">{errors.horario_id}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-3">
                                        Estado de asistencia <span className="text-red-500">*</span>
                                    </label>
                                ...
                                {selectedEstado && selectedEstado !== 'presente' && (
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                        ...
                                        <select
                                            ...
                                            onChange={(e) => setData('tipo_ausencia', e.target.value)}
                                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            required
                                        >
                                            {Object.entries(tiposAusencia).map(([value, label]) => (
                                        ...
                                        {errors.tipo_ausencia && (
                                            <p className="mt-1 text-sm text-red-600">{errors.tipo_ausencia}</p>
                                        )}
                                    </div>
                                )}
                                ...
                                {(selectedEstado === 'licencia' || selectedEstado === 'justificado') && (
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                        ...
                                        <div className="mt-1 flex items-center">
                                            <input
                                                type="file"
                                                onChange={(e) => setData('documento_respaldo', e.target.files[0])}
                                        ...
                                        {errors.documento_respaldo && (
                                            <p className="mt-1 text-sm text-red-600">{errors.documento_respaldo}</p>
                                        )}
                                    </div>
                                )}
                                ...
                                <div className="flex justify-end space-x-4 pt-4 border-t border-gray-200">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing || !data.horario_id || !data.estado}
