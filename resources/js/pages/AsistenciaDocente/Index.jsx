...
export default function Index({ asistencias, estadisticas, filtros, estados }) {
    ...
    const getEstadoBadge = (estado) => {
        const badges = {
            presente: 'px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800',
            ausente: 'px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800',
            licencia: 'px-2 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800',
            justificado: 'px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800',
        };
        return badges[estado] || 'px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-800';
    };
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-gray-900 mt-1">{estadisticas.total_registros}</p>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-green-600 mt-1">{estadisticas.total_presentes}</p>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-red-600 mt-1">{estadisticas.total_ausentes}</p>
                                </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-blue-600 mt-1">{estadisticas.porcentaje_asistencia}%</p>
                                </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        {asistencias.data.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <p className="mt-1 text-sm text-gray-500">Comienza registrando tu primera asistencia.</p>
                                <div className="mt-6">
                                    <Link
                                        href="/asistencia-docente/crear"
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {asistencias.data.map((asistencia) => (
                                                <tr key={asistencia.id} className="hover:bg-gray-50">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="text-sm text-gray-500">{formatHora(asistencia.hora_registro)}</div>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="text-sm font-medium text-gray-900">
                                                            {asistencia.horario?.materia?.nombre || 'N/A'}
                                                        </div>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                            <div>
                                                <p className="text-sm text-gray-700">
                                                    Mostrando <span className="font-medium">{asistencias.from}</span> a{' '}
                                                    <span className="font-medium">{asistencias.to}</span> de{' '}
                                                    <span className="font-medium">{asistencias.total}</span> resultados
                                                </p>
                                            </div>
                                            <div>
