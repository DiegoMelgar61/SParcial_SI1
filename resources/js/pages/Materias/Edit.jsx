...
export default function Edit({ materia, carreras }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        es_electiva: materia.es_electiva ?? false,
        requiere_laboratorio: materia.requiere_laboratorio ?? false,
    });
            ...
            <div className="py-6">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900">Editar Materia</h1>
