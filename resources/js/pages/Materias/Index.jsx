...
export default function Index({ materias, carreras, filters }) {
    ...
    const confirmDelete = () => {
        if (materiaToDelete) {
            router.delete(`/materias/${materiaToDelete.id}`, {
                onBefore: () => console.log('Eliminando materia...'),
                onSuccess: () => console.log('Materia eliminada'),
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p className="mt-1 text-sm text-gray-600">
                                Administra las materias de las carreras
                            </p>
                        </div>
                        <Link
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Programación, INF-111"
                    ...
                    <div className="bg-white rounded-lg shadow overflow-hidden">
                        {materias.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <h3 className="mt-2 text-sm font-medium text-gray-900">No hay materias registradas</h3>
                                    ...
                                    {materias.map((materia) => (
                                        <tr key={materia.id} className="hover:bg-gray-50">
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm font-medium text-gray-900">{materia.codigo}</div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="text-sm font-medium text-gray-900">{materia.nombre}</div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <div className="text-sm text-gray-500">{materia.carrera?.nombre}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm text-gray-900">{materia.semestre}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span className={`px-2 py-1 text-xs rounded-full ${
                                                    ...
                                                    {!materia.es_electiva ? 'Obligatoria' : 'Electiva'}
                                                </span>
                                            </td>
                            ...
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="sm:flex sm:items-start">
                                    ...
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <h3 className="text-lg leading-6 font-medium text-gray-900">Eliminar Materia</h3>
                                        <div className="mt-2">
                                            <p className="text-sm text-gray-500">
                                                ¿Estás seguro de eliminar <strong>{materiaToDelete?.nombre}</strong>? Esta acción no se puede deshacer.
                                            </p>
                                        </div>
                                    </div>
                                </div>
