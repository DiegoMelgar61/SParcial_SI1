...
export default function Edit({ docente, carreras, tiposContrato, turnos }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        horas_semanales_max: docente.horas_semanales_max || '',
        turnos_preferidos: docente.turnos_preferidos || [],
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2 bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div className="text-sm text-gray-900">
                                        <strong>{docente.usuario?.nombre} {docente.usuario?.apellido}</strong>
                                        <span className="text-gray-500 ml-2">({docente.usuario?.email})</span>
                                    </div>
                                    <p className="text-xs text-gray-500 mt-1">El usuario no puede ser modificado</p>
                                </div>
                                ...
                                <div className="bg-blue-50 p-4 rounded-lg">
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className="text-sm text-blue-700 font-medium">Horas Actuales</p>
                                            <p className="text-xs text-blue-600 mt-1">
                                                Este docente tiene asignadas <strong>{docente.horas_semanales_actuales || 0}</strong> horas semanales actualmente.
                                            </p>
                                        </div>
                                    </div>
                                </div>
