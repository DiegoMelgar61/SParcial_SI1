...
export default function AuthenticatedLayout({ children }) {
    ...
    const navigation = [
        ...
        { name: 'Horarios', href: '/horarios', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
                ...
                <div className="h-full px-4 py-6 overflow-y-auto">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-200">
                        <div className="px-4 py-3 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl">
                            <p className="text-xs font-semibold text-gray-900 mb-1">Soporte</p>
